  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          If I learn something new or something cool, I needed a simpler project
          to use as workbench. Using production data of paying customer is NOT a
          good idea.
        </li>
        ...
        <li>
          I wanted to do something well done to prove it helps in the long run.
          I would like to be ambitious and say... If I abandon it for more than
          6 months, I still should be able to compile. lol
        </li>
        <li>
